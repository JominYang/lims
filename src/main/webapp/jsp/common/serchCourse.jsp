...
function onsub(){  
	/*
      	...
      	+"--"+$('input:radio[name="weekend"]:checked').val()+"---"+$('#exp').combobox('getText')
	 			...
	 			window.location = "/lims/KeBiaoServlet?searchMethod=chakan&cuname="+cuname+"&dateStart="+dateStart;
  ...
  <body class="easyui-layout"  style="background:#EDF4FE">
    	...
    	<div id="regCenter" region="center" border="false" title="课表查询">
    		...
    		<th align="center" colspan="2" style="font-family: '微软雅黑';font-size: 12px;">课表查询</th>
...
或者
		<a  class="easyui-linkbutton" plain="true" name="week"  onclick="disable()" >按创建课表时间</a>
    		...
    		<td><a onclick="onsub();" class="easyui-linkbutton" iconCls="icon-search" >搜索</a></td>
    		</tr>
    		</table>
