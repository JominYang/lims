...
<html>
					...
					{text:'提交',
					 ...
					 handler:function(){
					 	...
					 	for(var i=0;i<rows.length;i++){
					 		if(rows[i].teacher_name!='可选'){
					 			$.messager.alert(
					 			 '警告','选择的课程中，已有老师['+rows[i].teacher_name+']选择，只能选择可选的课程!'
							);
					 	...
					 	$.ajax({
	 			url:sy.bp()+'/TeaXKServlet?sub=teacherXK',
	 			async: false,
	 			data:{
	 					ids:ids.join(',')
	 			},
  ...
  <body class="easyui-layout">
    		...
    		<td><a class="easyui-linkbutton" iconCls="icon-tick" plain="true" onclick="onsub();">提交</a><a class="easyui-linkbutton" iconCls="icon-undo" plain="true" onclick="clearFun();" href="javascript:void(0);">清空</a></td>
    		</tr>
    		</table>
    		</form>	 
    	</div> 
